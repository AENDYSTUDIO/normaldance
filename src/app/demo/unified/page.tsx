      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">
            🚀 TIER 1: Единая цифровая система
          </h1>
              ...
              <CardContent className="p-8">
                <blockquote className="text-center">
                  <p className="text-xl text-white mb-4">
                    <strong>Единая цифровая система</strong> объединяет все компоненты TIER 1 в целостную экосистему,<br/>
                    где каждый элемент работает в гармонии с остальными,<br/>
                    создавая непревзойдённый пользовательский опыт.
                  </p>
                  <footer className="text-gray-400">
                    — TIER 1: Единая цифровая система Философия
                  </footer>
                </blockquote>
              </CardContent>
            </Card>
