...
export function LandingHero({ title, subtitle, ctaText, loading = false }: LandingHeroProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-600 to-fuchsia-700 text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <form onSubmit={submit} className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            >
              {status==='loading' || loading ? 'Joining…' : ctaText}
            </button>
          </form>
