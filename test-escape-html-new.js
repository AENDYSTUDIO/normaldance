...
const test1 = '<div>alert("xss")</div>';
const result1 = escapeHTML(test1);
console.log("Вход:", test1);
console.log("Выход:", result1);
console.log("Ожидается: &lt;div&gt;alert(&quot;xss&quot;)&lt;&#x2F;div&gt;");
console.log("Результат верен:", result1 === '&lt;div&gt;alert(&quot;xss&quot;)&lt;&#x2F;div&gt;');
